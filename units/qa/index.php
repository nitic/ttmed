...
<head>
<meta charset="UTF-8" />
<title>งานการประกันคุณภาพ :: คณะการเเพทย์แผนไทย มหาวิทยาลัยสงขลานครินทร์</title>
...
<section id="top">
<nav>
<h1 id="sitename">งานการประกันคุณภาพ </h1>
...
<?php
 ...
 $e = new document();
                $data = $e->get_section_by_categoryID(2);
...
<blockquote>
<p><a href="http://www.qa.psu.ac.th/" target="_blank">สำนักงานประกันคุณภาพ </a></p>
<cite>สำนักงานประกันคุณภาพ มหาวิทยาลัยสงขลานครินทร์</cite>
</blockquote>
...
<div class="block2">
<h2>ที่ตั้ง</h2>
<p>งานการประกันคุณภาพ คณะการแพทย์แผนไทย</p>
