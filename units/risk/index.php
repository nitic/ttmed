...
<head>
<meta charset="UTF-8" />
<title>งานบริหารความเสี่ยง :: คณะการเเพทย์แผนไทย มหาวิทยาลัยสงขลานครินทร์</title>
...
<section id="top">
<nav>
<h1 id="sitename">งานบริหารความเสี่ยง </h1>
...
<?php
 ...
 $e = new document();
                $data = $e->get_section_by_categoryID(5);
...
<div class="block2">
<h2>ที่ตั้ง</h2>
<p>งานบริหารความเสี่ยง คณะการแพทย์แผนไทย</p>
