...
$title = 'อาจารย์สาขาเวชกรรมไทย';
$email = 'ttmed-lecturer@group.psu.ac.th ';
$pathway = '<li><span>บุคลากร</span><span class="divider">/</span></li>
            <li><span>คณาจารย์</span><span class="divider">/</span></li>
            <li><span>อาจารย์สาขาเวชกรรมไทย</span></li>';
$tags = array('บุคลากร', 'คณาจารย์', 'อาจารย์', 'เวชกรรมไทย');
       ...
       <tbody>
        ...
        <tr>
		 ...
		 <dl class="dl-horizontal">
		  ...
		  <dd><h4>ดร.กิ่งกาญจน์  บรรลือพืช</h4></dd>
		  <dd>อาจารย์ประจำ</dd>
		  <dd>โทร: 0 7428 2722</dd>
		  <dd>อีเมล์: kingkan.bu@psu.ac.th</dd> 
		</dl>
           </td>
        </tr>
        <tr>
        ...
        <tr>
          <td> 
		 <dl class="dl-horizontal">
		  <dt><img src="images/staff/teacher/kotchakorn.png" alt="อ.กชกร มุสิกพงษ์" /></dt>
		  <dd><h4>อ.กชกร มุสิกพงษ์</h4></dd>
		  <dd>อาจารย์ผู้ช่วยสอน</dd>
		  <dd>โทร: 0 7428 2721 </dd>
		  <dd>อีเมล์: kotchakorn.m@psu.ac.th</dd> 
		</dl>
           </td>
        </tr>
        <tr>
          <td> 
		 <dl class="dl-horizontal">
		  <dt><img src="images/staff/teacher/thapanee.png" alt="อ.ฐาปนีย์ เขียวจีน" /></dt>
		  <dd><h4>อ.ฐาปนีย์ เขียวจีน</h4></dd>

		  <dd>อาจารย์ผู้ช่วยสอน</dd>
		  <dd>โทร: 0 7428 2721 </dd>
		  <dd>อีเมล์: thapanee.k@psu.ac.th</dd> 
		</dl>
           </td>
        </tr>
		<tr>
          <td> 
		 <dl class="dl-horizontal">
		  <dt><img src="images/staff/teacher/kawin.png" alt="อ.กวิน  กปิลกาญจน์" /></dt>
		  <dd><h4>อ.กวิน  กปิลกาญจน์</h4></dd>
		  <dd>อาจารย์ผู้ช่วยสอน</dd>
		  <dd>โทร: 0 7428 2722 </dd>
		  <dd>อีเมล์: kawin.ka@psu.ac.th</dd> 
		</dl>
           </td>
        </tr>
      </tbody>
