...
<div id="k2Container" class="itemView">
	...
	<div class="k2InfoWrap">
	   ...
	   <span class="itemDateCreated">branch</span>		
	   <span class="itemDayCreated"><i class="icon-sitemap"></i></span> 	
        </div>        	
</div> 
<!--End K2 Info Wrapper -->
...
<div class="itemToolbar">
   ...
   <li>
    ...
    <!-- Item category -->
   <li>
    <span class="itemCategory">Published in &nbsp;<a href="../../printing.html">สาขาวิชา/หน่วยงาน</a></span></li>    
...
<h3 class="module-title "><span>สาขาวิชา / หน่วยงาน</span></h3>
<div class="module-ct">
  <ul class="nav ">
    <li class="item-435"><a href="branch.php?page=medicine" >สาขาเวชกรรมไทย</a></li>
    <li class="item-233 active parent"><a href="branch.php?page=drugs" >สาขาเภสัชกรรมไทย</a></li>
    <li class="item-489"><a href="branch.php?page=massage" >สาขานวดไทย</a></li>
    <li class="item-532"><a href="branch.php?page=midwifery" >สาขาผดุงครรภ์ไทย</a></li>
    <li class="item-238 parent"><a href="branch.php?page=hospital" >โรงพยาบาลการแพทย์แผนไทย</a></li>
  </ul>
</div></div></div>
